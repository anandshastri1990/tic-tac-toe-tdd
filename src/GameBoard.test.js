...
describe('Game board', () => {
    ...
    it('should highlight given boxes with player specific color for player 1', function () {
        ...
        expect(component.find('#game-board').find('#box-1').get(0).props.className).toEqual('box highlight-teal');
        ...
        expect(component.find('#game-board').find('#box-5').get(0).props.className).toEqual('box highlight-teal');
